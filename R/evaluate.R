evaluate <- function(scans, solutions, partial = TRUE, negative = FALSE, rule="false", ...
                   ) {
...
exams::nops_eval(register= NULL,
                 solutions = solutions,
                  scans = scans,
                 eval = exams_eval(partial = partial, negative = negative, rule=rule ))
}
